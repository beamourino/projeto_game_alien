...
class FleetManager:
    """Classe responsável pelos métodos de criar e gerenciar a frota de alienígenas."""
    ...
    def _check_ship_collision(self, ship) -> None:
        """Verifica se algum alienígena colidiu com algum alienígena"""
